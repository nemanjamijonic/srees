    ...
    public class SubstationService : ISubstationService
    {
        ...
        public async Task<ResponsePackage<List<SubstationDataOut>>> GetAllSubstations()
        {
            try
            {
                ...
                return new ResponsePackage<List<SubstationDataOut>>(substationList, "Transformatorske stanice uspe�no preuzete");
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "Gre�ka pri preuzimanju svih transformatorskih stanica");
                return new ResponsePackage<List<SubstationDataOut>>(null, "Gre�ka pri preuzimanju transformatorskih stanica");
            }
        }
        ...
        public async Task<ResponsePackage<List<SubstationSelectDataOut>>> GetAllSubstationsForSelect()
        {
            try
            {
                ...
                return new ResponsePackage<List<SubstationSelectDataOut>>(substationSelectList, "Transformatorske stanice za select uspe�no preuzete");
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "Gre�ka pri preuzimanju transformatorskih stanica za select");
                return new ResponsePackage<List<SubstationSelectDataOut>>(null, "Gre�ka pri preuzimanju transformatorskih stanica za select");
            }
        }
        ...
        public async Task<ResponsePackage<SubstationDataOut?>> GetSubstationById(int id)
        {
            try
            {
                ...
                return new ResponsePackage<SubstationDataOut?>(substationDataOut, "Transformatorska stanica uspe�no preuzeta");
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "Gre�ka pri preuzimanju transformatorske stanice sa ID-om {SubstationId}", id);
                return new ResponsePackage<SubstationDataOut?>(null, "Gre�ka pri preuzimanju transformatorske stanice");
            }
        }
        ...
        public async Task<ResponsePackage<SubstationDataOut?>> CreateSubstation(SubstationDataIn substationDataIn)
        {
            try
            {
                ...
                var substationDataOut = _mapper.Map<SubstationDataOut>(substation);
                return new ResponsePackage<SubstationDataOut?>(substationDataOut, "Transformatorska stanica uspe�no kreirana");
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "Gre�ka pri kreiranju transformatorske stanice");
                return new ResponsePackage<SubstationDataOut?>(null, "Gre�ka pri kreiranju transformatorske stanice");
            }
        }
        ...
        public async Task<ResponsePackage<SubstationDataOut?>> UpdateSubstation(int id, SubstationDataIn substationDataIn)
        {
            try
            {
                ...
                var substationDataOut = _mapper.Map<SubstationDataOut>(substation);
                return new ResponsePackage<SubstationDataOut?>(substationDataOut, "Transformatorska stanica uspe�no a�urirana");
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "Gre�ka pri a�uriranju transformatorske stanice sa ID-om {SubstationId}", id);
                return new ResponsePackage<SubstationDataOut?>(null, "Gre�ka pri a�uriranju transformatorske stanice");
            }
        }
        ...
        public async Task<ResponsePackage<PaginatedResponse<List<SubstationDataOut>>>> GetSubstationsFiltered(SubstationFilterRequest filterRequest)
        {
            try
            {
                ...
                return new ResponsePackage<PaginatedResponse<List<SubstationDataOut>>>(paginatedResponse, "Transformatorske stanice uspešno filtrirane");
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "Greška pri filtriranju transformatorskih stanica");
                return new ResponsePackage<PaginatedResponse<List<SubstationDataOut>>>(null, "Greška pri filtriranju transformatorskih stanica");
            }
        }
    }
}
